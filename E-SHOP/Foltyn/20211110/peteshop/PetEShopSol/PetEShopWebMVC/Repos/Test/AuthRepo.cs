...
namespace PetEShopWebMVC.Repos.Test
{
    ...
    public class AuthRepo : IAuthRepo
    {
        ...
        /// <summary>
        /// Gets a complete list of all identity users.
        /// </summary>
        /// <returns>Returns the list of all identity users.</returns>
        public IList<IdentityUser> GetList()
        {
            ...
            var query = from u in context.Users
                        select u;
            var users = query.ToList<IdentityUser>();
